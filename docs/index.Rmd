...
# Introduction
Bloomington Animal Care and Control data is available through [BClear](https://data.bloomington.in.gov/), data portal for Bloomington, Indiana's city government. The Animal Care and Control Division has prepared two data sets that the public may use to understand how the city handles animal welfare. 

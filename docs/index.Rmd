...
A ZIP copy of files produced by data processing scripts is available to download from the GitHub repository:
...
1. Animal Identification data
2. Intake Case data
3. Movement data (adoptions, fosters, transfers, etc.)
4. Returned Animals data
5. Deceased Animals data
6. Animal Case Intake and Outcome log
7. Supplemental Animal Statistics
...
### 7. Supplemental Statistic for Animal Data

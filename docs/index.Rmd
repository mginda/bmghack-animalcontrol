...
### **[Download Processed Animal Care and Control  Data](https://github.com/mginda/bmghack-animalcontrol/raw/master/data/bmg-acc-data.zip)**

The download link provides a ZIP file the data processing outputs produced by the scripts documented in this workflow.
